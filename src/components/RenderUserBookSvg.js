...
const RenderUserBookSvg = ({book}) => {
  return (
    <div className="svgDiv">
      {/* <svg width="100%" height="100%" viewBox="0 0 4132 2471" version="1.1" xmlns="http://www.w3.org/2000/svg" > */}
      <svg width="100%" height="100%" viewBox="1000 700 2749 600" version="1.1" xmlns="http://www.w3.org/2000/svg" >
        <g>
          <path d="M1503.26,789.27l-0.406,448.705l1928.6,1.747l0.406,-448.705l-1928.6,-1.747Z"/>
          <path d="M1503.25,795.305l-0.395,436l1928.6,1.747l0.395,-436l-1928.6,-1.747Z" fill="#00602c" />
          <path d="M1503.23,823.212l-0.345,380.953l1928.6,1.747l0.345,-380.953l-1928.6,-1.747Z" fill="url(#_Linear1)"/>
